import Foundation
    ...
    ///
    /// Deterministas a propósito: las capturas deben ser reproducibles.
    ///
    /// **Envuelto en `#if DEBUG`**: no existe siquiera en un build de release. Una
    /// instalación nueva arranca con cero actividades, cero score y cero insights.
    /// Los datos solo llegan a la app bajo UI tests, y en un contenedor en memoria.
